...
class NetworkTestCase(TestCase):
    def setUp(self):
        ...
        post2 = Post.objects.create(
            author=user2, content="2 Post", is_reply=True)
    ...
    def test_invalid_post_reply(self):
        ...
        # is_reply marked False, but in post5 replies
        self.assertFalse(p3.is_valid_post())
    ...
    def test_invalid_profile_page(self):
        c = Client()
        response = c.get("/notvaliduser")
        self.assertEqual(response.status_code, 404)

    def test_valid_login(self):
        c = Client()
        response = c.post(
            '/login', {'username': 'user1', 'password': 'user1pw'})
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, '/')  # redirected to index

    def test_valid_registration(self):
        c = Client()
        response = c.post('/register', {'username': 'testValid', 'email': 'user@user.email.com',
    ...
    def test_following_page_not_authorized(self):
        c = Client()
    ...
    def test_api_valid_post(self):
        ...
        response = c.post(
            "/api", {'type': 'new', 'post': 'New post'}, content_type='application/json')
    ...
    def test_api_invalid_post(self):
        ...
        response = c.post(
            "/api", {'type': 'nnew', 'post': 'Error post'}, content_type='application/json')
        self.assertEqual(response.status_code, 400)  # invalid type
        response = c.post(
            "/api", {'type': 'reply', 'post': 'Error post'}, content_type='application/json')
        self.assertEqual(response.status_code, 400)  # missing id
        response = c.post("/api", {'type': 'reply', 'post': 'Error post',
                          'id': 100}, content_type='application/json')
        # invalid id (not in the db)
        self.assertEqual(response.status_code, 400)
        p3 = Post.objects.get(content="3 Post")
        response = c.post("/api", {'type': 'edit', 'post': 'Error post',
                          'id': p3.id}, content_type='application/json')
        # user not authorized to edit another user's post
    ...
    def test_api_reply(self):
        ...
        response = c.post("/api", {'type': 'reply', 'post': 'Reply',
                          'id': post.id}, content_type='application/json')
        self.assertEqual(response.status_code, 201)
    ...
    def test_invalid_api_following(self):
        ...
        self.assertEqual(response.status_code, 403)  # user not authenticated
    ...
    def test_api_valid_like(self):
        ...
        response = c.put(
            "/api/update", {'type': 'like', 'id': post.id}, content_type='application/json')
        self.assertEqual(response.status_code, 201)
    ...
    def test_api_invalid_like(self):
        ...
        c.login(username="user1", password="user1pw")
        response = c.put(
            "/api/update", {'type': 'like'}, content_type='application/json')
        self.assertEqual(response.status_code, 400)  # missing id
        response = c.put(
            "/api/update", {'type': 'like', 'id': 100}, content_type='application/json')
    ...
    def test_api_valid_follow(self):
        ...
        c.login(username="user2", password="user2pw")
        response = c.put(
            "/api/update", {'type': 'follow', 'id': u3.id}, content_type='application/json')
        self.assertEqual(response.status_code, 201)
    ...
    def test_api_invalid_follow(self):
        ...
        c.login(username="user1", password="user1pw")
        response = c.put(
            "/api/update", {'type': 'follow', 'id': u1.id}, content_type='application/json')
        self.assertEqual(response.status_code, 400)
